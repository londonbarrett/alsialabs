...
- [x] 4.5 Add View / Edit / Delete buttons in Actions column with dummy toast handlers
...
- [x] 6.1 Add "Clients" link to `config/sidebar-menu.json` under Navigation group with URL `/dashboard/clients`
